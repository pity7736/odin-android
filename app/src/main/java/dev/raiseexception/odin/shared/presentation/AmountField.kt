...
fun AmountField(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        OutlinedTextField(
            value = value,
            onValueChange = { onValueChange(filterAmountInput(it, decimalSeparator, maxDecimals)) },
            singleLine = true,
            ...
            visualTransformation = AmountVisualTransformation(decimalSeparator, groupingSeparator),
            modifier = Modifier
                .fillMaxWidth()
                .testTag(testTag),
        )
        AmountFieldError(errorMessage, "${testTag}_error")
    }
}

@Composable
private fun AmountFieldError(errorMessage: String?, testTag: String) {
